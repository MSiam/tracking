...
elseif exist([video_path num2str(frames{1}, 'imgs/frame%05i.jpg')], 'file'),%this is where, %08i
    video_path = [video_path 'imgs/'];
    img_files = num2str((frames{1} : frames{2})', 'frame%05i.jpg');
elseif exist([video_path num2str(frames{1}, 'imgs/%09i.bmp')], 'file'),
    video_path = [video_path 'imgs/'];
