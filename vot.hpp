...
public:
    ...
    {
		//ofstream bla("C://Users//mincosy//Desktop//Tracking//Final_DSST_C++//DSST//log.txt");
		//bla<<"here"<<endl;
        ...
        if (p_region_stream.is_open()){
			...
			//bla<<"opened file"<<p.x1<<endl;
        }else{
			//bla<<"couldnt open file"<<endl;
        ...
        p_init_polygon = p;
		//bla<<"init polygon"<<p_init_polygon.x1<<endl;
    ...
    inline int getNextImage(cv::Mat & img)//, bool init)
    {
